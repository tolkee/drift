...
// biome-ignore lint/suspicious/noExplicitAny: reui code
export const KanbanContext = React.createContext<KanbanContextProps<any>>({
  columns: {},
  setColumns: () => {},
  getItemId: () => "",
  columnIds: [],
  ...
  return (
    <SortableContext items={columnIds} strategy={rectSortingStrategy}>
      <ScrollArea className="h-full">
        <div
          className={cn("flex flex-col md:flex-row gap-4 h-full", className)}
        >
          {children}
        </div>
  ...
  return (
    ...
    >
      <div
        ...
        {...listeners}
        className={cn(
          "group/kanban-column flex flex-col cursor-grab",
